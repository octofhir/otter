...
pub fn feature_edition(feature: &str) -> EsEdition {
    match feature {
        // === ES2015 (ES6) ===
        "arrow-function" | "Array.from" | "Array.of" | "Array.prototype.entries"
        | "Array.prototype.fill" | "Array.prototype.find" | "Array.prototype.findIndex"
        | "Array.prototype.keys" | "Array.prototype.values" | "Array.prototype[@@iterator]"
        | "class" | "computed-property-names" | "const" | "DataView" | "default-parameters"
        | "destructuring-assignment" | "destructuring-binding" | "for-of" | "generators"
        | "let" | "Map" | "new.target" | "Number.isFinite" | "Number.isInteger"
        | "Number.isNaN" | "Number.parseFloat" | "Number.parseInt" | "Number.MAX_SAFE_INTEGER"
        | "Number.MIN_SAFE_INTEGER" | "Number.isSafeInteger" | "Number.EPSILON"
        | "object-rest" | "object-spread" | "Object.assign" | "Object.getOwnPropertySymbols"
        | "Object.is" | "Object.setPrototypeOf" | "Promise" | "Proxy" | "proxy-missing-checks"
        | "Reflect" | "Reflect.apply" | "Reflect.construct" | "Reflect.defineProperty"
        ...
        | "regexp-dotall" | "Set" | "String.fromCodePoint" | "String.prototype.codePointAt"
        | "String.prototype.endsWith" | "String.prototype.includes"
        | "String.prototype.normalize" | "String.prototype.repeat"
        | "String.prototype.startsWith" | "String.prototype[@@iterator]" | "String.raw"
        | "super" | "Symbol" | "Symbol.hasInstance" | "Symbol.isConcatSpreadable"
        | "Symbol.iterator" | "Symbol.species" | "Symbol.toPrimitive" | "Symbol.toStringTag"
        | "Symbol.unscopables" | "tail-call-optimization" | "template" | "TypedArray"
        | "u180e" | "WeakMap" | "WeakSet" => EsEdition::ES2015,

        // === ES2016 (ES7) ===
        "Array.prototype.includes" | "exponentiation" => EsEdition::ES2016,

        // === ES2017 (ES8) ===
        "async-functions" | "Atomics" | "Object.entries" | "Object.getOwnPropertyDescriptors"
        | "Object.values" | "SharedArrayBuffer" | "String.prototype.padEnd"
        | "String.prototype.padStart" => EsEdition::ES2017,

        // === ES2018 (ES9) ===
        "async-iteration" | "dotAll" | "named-capture-groups" | "regexp-lookbehind"
        | "regexp-named-groups" | "regexp-unicode-property-escapes" | "s-flag"
        | "Promise.prototype.finally" => EsEdition::ES2018,

        // === ES2019 (ES10) ===
        "Array.prototype.flat" | "Array.prototype.flatMap" | "json-superset"
        | "Object.fromEntries" | "optional-catch-binding" | "String.prototype.trimEnd"
        | "String.prototype.trimStart" | "Symbol.prototype.description"
        | "well-formed-json-stringify" => EsEdition::ES2019,

        // === ES2020 (ES11) ===
        "BigInt" | "dynamic-import" | "globalThis" | "import.meta" | "matchAll"
        | "optional-chaining" | "Promise.allSettled" | "String.prototype.matchAll"
        | "nullish-coalescing" => EsEdition::ES2020,

        // === ES2021 (ES12) ===
        "AggregateError" | "FinalizationRegistry" | "logical-assignment-operators"
        | "numeric-separator-literal" | "Promise.any" | "String.prototype.replaceAll"
        | "WeakRef" => EsEdition::ES2021,

        // === ES2022 (ES13) ===
        "class-fields-private" | "class-fields-public" | "class-methods-private"
        | "class-static-block" | "class-static-fields-private" | "class-static-fields-public"
        | "class-static-methods-private" | "error-cause" | "Object.hasOwn"
        | "regexp-match-indices" | "top-level-await" | "at" | "Array.prototype.at"
        | "String.prototype.at" | "TypedArray.prototype.at" => EsEdition::ES2022,

        // === ES2023 (ES14) ===
        "Array.prototype.findLast" | "Array.prototype.findLastIndex"
        | "change-array-by-copy" | "hashbang" | "symbols-as-weakmap-keys"
        ...
        | "TypedArray.prototype.toReversed" | "TypedArray.prototype.toSorted"
        | "TypedArray.prototype.with" => EsEdition::ES2023,

        // === ES2024 (ES15) ===
        "arraybuffer-transfer" | "resizable-arraybuffer" | "Atomics.waitAsync"
        | "promise-with-resolvers" | "regexp-v-flag" | "array-grouping" | "Object.groupBy"
        | "Map.groupBy" | "well-formed-unicode-strings"
        | "String.prototype.isWellFormed" | "String.prototype.toWellFormed" => EsEdition::ES2024,

        // === ESNext (proposals) ===
        "Temporal" | "decorators" | "explicit-resource-management" | "import-assertions"
        | "import-attributes" | "json-modules" | "ShadowRealm" | "iterator-helpers"
        | "set-methods" | "Array.fromAsync" | "Uint8Array" | "regexp-duplicate-named-groups"
        | "Intl" | "Intl.DateTimeFormat" | "Intl.DisplayNames" | "Intl.ListFormat"
        | "Intl.Locale" | "Intl.NumberFormat" | "Intl.PluralRules"
        | "Intl.RelativeTimeFormat" | "Intl.Segmenter" | "Intl-enumeration" => EsEdition::ESNext,
...
pub fn print_edition_table(editions: &HashMap<EsEdition, EditionReport>) {
    ...
    println!();
    println!("{}", "=== Conformance by ECMAScript Edition ===".bold().cyan());
    println!(
        "{:<10} {:>8} {:>8} {:>8} {:>8} {:>10}",
