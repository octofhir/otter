...
pub const OP_BYTE_TABLE: &[(Op, u8)] = &[
    ...
    (Op::CollectRest, 0x48),
    (Op::ReturnValue, 0x49),
    (Op::ReturnUndefined, 0x4A),
    (Op::NewObject, 0x4B),
    (Op::LoadProperty, 0x4C),
    (Op::StoreProperty, 0x4D),
    (Op::DeleteProperty, 0x4E),
    (Op::GetPrototype, 0x4F),
    (Op::SetPrototype, 0x50),
    (Op::NewArray, 0x51),
    (Op::LoadElement, 0x52),
    (Op::StoreElement, 0x53),
    (Op::ArrayLength, 0x54),
    (Op::HasProperty, 0x55),
    (Op::Instanceof, 0x56),
    (Op::Eval, 0x57),
    (Op::NewFunction, 0x58),
    (Op::GlobalCall, 0x59),
    (Op::LoadGlobalThis, 0x5A),
    (Op::LoadGlobalOrThrow, 0x5B),
    (Op::CollectArguments, 0x5C),
    (Op::LoadGlobalOrUndefined, 0x5D),
    (Op::DefineGlobalVar, 0x5E),
    (Op::ImportMetaResolve, 0x5F),
    (Op::ImportNamespaceDynamic, 0x60),
    (Op::ImportNamespace, 0x61),
    (Op::PromiseFulfilledOf, 0x62),
    (Op::NewIntl, 0x63),
    (Op::TemporalCall, 0x64),
    (Op::TemporalLoad, 0x65),
    (Op::NewCollection, 0x66),
    (Op::NewWeakRef, 0x67),
    (Op::NewFinalizationRegistry, 0x68),
    (Op::SymbolLoad, 0x69),
    (Op::SymbolCall, 0x6A),
    (Op::TypeOf, 0x6B),
    (Op::DeleteElement, 0x6C),
    (Op::Await, 0x6D),
    (Op::SameValue, 0x6E),
    (Op::IsArray, 0x6F),
    (Op::LooseEqual, 0x70),
    (Op::LooseNotEqual, 0x71),
    (Op::NewBuiltinError, 0x72),
    (Op::LoadBuiltinError, 0x73),
    (Op::DateCall, 0x74),
    (Op::BigIntCall, 0x75),
    (Op::ArrayConstruct, 0x76),
    (Op::ArrayFrom, 0x77),
    (Op::ArrayOf, 0x78),
    (Op::ObjectCall, 0x79),
    (Op::ArrayBufferCall, 0x7A),
    (Op::DataViewCall, 0x7B),
    (Op::TypedArrayCall, 0x7C),
    (Op::Yield, 0x7D),
    (Op::SharedArrayBufferCall, 0x7E),
    (Op::ProxyCall, 0x7F),
    (Op::ReflectCall, 0x80),
    (Op::IteratorCall, 0x81),
    (Op::ToPrimitive, 0x82),
];
...
mod tests {
    ...
    fn coverage_matches_dispatcher_enum_size() {
        ...
        const EXPECTED_OPCODE_COUNT: usize = 131;
        assert_eq!(
            OP_BYTE_TABLE.len(),
