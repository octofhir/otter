...
- [x] Remove the measured duplicate instruction/operand decoding path: the VM
  ...
  hot dispatch reads it without repeated function-table lookup. Across the five
  controlled kernels this improved interpreter medians by 1.82-2.21x and cut
  the property-kernel Node `--jitless` gap from 27.2x to 12.9x with unchanged
  peak RSS.
