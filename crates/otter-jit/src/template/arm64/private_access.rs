//! Private-member access transition emission.
//!
//! # Contents
//! - Reentrant calls to the VM-owned private-element helper.
//! - Uniform success, throw, and exact pre-effect bailout routing.
//!
//! # Invariants
//! - The VM helper commits every supported private opcode before returning
...
//!   any observable private accessor getter/setter.
//!
//! # See also
...
pub(super) fn emit_private_op(
    ...
    emit_load_u64(
        ops,
        16,
        transitions.variadic_entry(abi::STUB_JIT_PRIVATE_OP),
    );
    dynasm!(ops
        ; .arch aarch64
        ; blr x16
