...
//!
//! # Invariants
//! - The VM helper commits every supported load opcode before returning
//!   success, so generated code only falls through once.
//! - A missing published activation is the sole bailout case.
//!
//! # See also
//! - `otter_vm::native_abi::RuntimeCall::value_load_op`
...
pub(super) fn emit_value_load_op(
    ops: &mut Assembler,
    ...
    emit_load_runtime_stub(
        ...
        relocations,
        16,
        transitions.variadic_entry(abi::STUB_JIT_VALUE_LOAD_OP),
