//! Allocating-construction transition emission.
//!
//! # Contents
//! - Reentrant calls to the VM-owned construction helper.
//! - Uniform success, throw, and exact pre-effect bailout routing.
//!
//! # Invariants
//! - The VM helper commits every supported construction opcode before returning
...
pub(super) fn emit_construct_op(
    ops: &mut Assembler,
