...
use super::{
    ...
    NATIVE_FRAME_OFFSET, NUMBER_TAG_HI16, OBJECT_BODY_TYPE_TAG, Op, REG_STACK_BASE_OFFSET,
    REG_TOP_PTR_OFFSET, RESUME_PC_OFFSET, STATUS_BAILED, STATUS_RETURNED, STATUS_THREW,
