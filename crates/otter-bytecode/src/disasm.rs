...
000087 COLLECT_REST\n\
000088 RETURN_VALUE\n\
000089 RETURN_UNDEFINED\n\
000090 NEW_OBJECT\n\
000091 LOAD_PROPERTY\n\
000092 STORE_PROPERTY\n\
000093 DELETE_PROPERTY\n\
000094 GET_PROTOTYPE\n\
000095 SET_PROTOTYPE\n\
000096 NEW_ARRAY\n\
000097 LOAD_ELEMENT\n\
000098 STORE_ELEMENT\n\
000099 ARRAY_LENGTH\n\
000100 HAS_PROPERTY\n\
000101 INSTANCEOF\n\
000102 EVAL\n\
000103 IS_EVAL_INTRINSIC\n\
000104 NEW_FUNCTION\n\
000105 LOAD_GLOBAL_THIS\n\
000106 LOAD_GLOBAL_OR_THROW\n\
000107 COLLECT_ARGUMENTS\n\
000108 LOAD_GLOBAL_OR_UNDEFINED\n\
000109 DEFINE_GLOBAL_VAR\n\
000110 IMPORT_META_RESOLVE\n\
000111 IMPORT_NAMESPACE_DYNAMIC\n\
000112 IMPORT_NAMESPACE\n\
000113 IMPORT_NAMESPACE_DEFERRED\n\
000114 EVALUATE_MODULE\n\
000115 MARK_MODULE_EVALUATED\n\
000116 STAR_REEXPORT\n\
000117 MODULE_NAMESPACE_OBJECT\n\
000118 LOAD_IMPORT_BINDING\n\
000119 PROMISE_FULFILLED_OF\n\
000120 TEMPORAL_LOAD\n\
000121 NEW_COLLECTION\n\
000122 NEW_WEAK_REF\n\
000123 NEW_FINALIZATION_REGISTRY\n\
000124 SYMBOL_LOAD\n\
000125 TYPEOF\n\
000126 DELETE_ELEMENT\n\
000127 AWAIT\n\
000128 SAME_VALUE\n\
000129 IS_ARRAY\n\
000130 LOOSE_EQ\n\
000131 LOOSE_NEQ\n\
000132 NEW_BUILTIN_ERROR\n\
000133 LOAD_BUILTIN_ERROR\n\
000134 BIGINT_CALL\n\
000135 ARRAY_CONSTRUCT\n\
000136 ARRAY_FROM\n\
000137 ARRAY_OF\n\
000138 ARRAY_BUFFER_CALL\n\
000139 DATA_VIEW_CALL\n\
000140 YIELD\n\
000141 SHARED_ARRAY_BUFFER_CALL\n\
000142 TO_PRIMITIVE\n\
000143 FOR_IN_KEYS\n\
000144 COPY_DATA_PROPERTIES\n\
000145 DEFINE_OWN_PROPERTY\n";
}
