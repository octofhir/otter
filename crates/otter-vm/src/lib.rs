...
// The otter-themed macros emit code against the absolute
// `::otter_vm::__macro_support::*` path so consumers outside
...
///
/// This module is public only because procedural-macro expansions execute in
/// the downstream crate. It is not a stable embedding API.
#[doc(hidden)]
pub mod __macro_support {
    pub use crate::bootstrap::BootstrapFeatures;
    pub use crate::intrinsic_install::BuiltinIntrinsic;
...
pub use jit::{
    ...
    JitInlineMethod, JitInstructionMetadata, JitPropertyIcWay, JitRuntimeStubBinding,
