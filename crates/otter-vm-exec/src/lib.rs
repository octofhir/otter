...
pub use jit_runtime::{
    ...
    JitRuntimeStats, compile_one_pending_request, deopt_metadata_snapshot, hydrate_jit_entry_ptr,
    invalidate_jit_code, is_jit_background_enabled, is_jit_eager_enabled, is_jit_enabled,
