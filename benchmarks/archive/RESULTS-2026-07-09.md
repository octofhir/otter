...
> [!WARNING]
> Archived historical results captured on 2026-07-09. They are not a current
> performance baseline, do not define the current benchmark format, and are not
> maintained. Old runner assumptions and result paths are intentionally
> unsupported.
