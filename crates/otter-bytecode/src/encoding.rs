...
pub const OP_BYTE_TABLE: &[(Op, u8)] = &[
    ...
    (Op::NewIntl, 0x61),
    (Op::TemporalCall, 0x62),
    (Op::TemporalLoad, 0x63),
    (Op::NewCollection, 0x64),
    (Op::NewWeakRef, 0x65),
    (Op::NewFinalizationRegistry, 0x66),
    (Op::SymbolLoad, 0x67),
    (Op::TypeOf, 0x68),
    (Op::DeleteElement, 0x69),
    (Op::Await, 0x6A),
    (Op::SameValue, 0x6B),
    (Op::IsArray, 0x6C),
    (Op::LooseEqual, 0x6D),
    (Op::LooseNotEqual, 0x6E),
    (Op::NewBuiltinError, 0x6F),
    (Op::LoadBuiltinError, 0x70),
    (Op::BigIntCall, 0x71),
    (Op::ArrayConstruct, 0x72),
    (Op::ArrayFrom, 0x73),
    (Op::ArrayOf, 0x74),
    (Op::ObjectCall, 0x75),
    (Op::ArrayBufferCall, 0x76),
    (Op::DataViewCall, 0x77),
    (Op::Yield, 0x78),
    (Op::SharedArrayBufferCall, 0x79),
    (Op::ToPrimitive, 0x7A),
];
...
mod tests {
    ...
    fn coverage_matches_dispatcher_enum_size() {
        ...
        const EXPECTED_OPCODE_COUNT: usize = 123;
        assert_eq!(
            OP_BYTE_TABLE.len(),
