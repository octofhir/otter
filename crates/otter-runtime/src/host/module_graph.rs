...
mod tests {
    ...
    use super::*;
    use crate::host::ModuleLoaderConfig;
    ...
    #[test]
    fn load_graph_collects_static_esm_edges() {
        let dir = temp_test_dir("graph-esm");
        std::fs::write(
            dir.join("main.mjs"),
            "import './dep.js'; export { value } from './dep2.js';\nconsole.log('ok');",
        )
        .expect("main should write");
        std::fs::write(dir.join("dep.js"), "export const x = 1;").expect("dep should write");
        std::fs::write(dir.join("dep2.js"), "export const value = 2;").expect("dep2 should write");
