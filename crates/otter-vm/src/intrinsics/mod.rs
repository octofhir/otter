...
fn alloc_intrinsic_object(heap: &mut ObjectHeap) -> ObjectHandle {
    heap.alloc_object()
        .expect("intrinsic root allocation should fit")
}
...
impl VmIntrinsics {
    ...
    pub fn allocate(heap: &mut ObjectHeap) -> Self {
        let global_object = alloc_intrinsic_object(heap);
        let object_prototype = alloc_intrinsic_object(heap);
        let function_prototype = alloc_intrinsic_object(heap);
        let string_constructor = alloc_intrinsic_object(heap);
        let symbol_constructor = alloc_intrinsic_object(heap);
        let number_constructor = alloc_intrinsic_object(heap);
        let boolean_constructor = alloc_intrinsic_object(heap);
        let date_constructor = alloc_intrinsic_object(heap);
        let object_constructor = alloc_intrinsic_object(heap);
        let function_constructor = alloc_intrinsic_object(heap);
        let array_constructor = alloc_intrinsic_object(heap);
        let array_prototype = alloc_intrinsic_object(heap);
        let array_buffer_constructor = alloc_intrinsic_object(heap);
        let array_buffer_prototype = alloc_intrinsic_object(heap);
        let bigint_constructor = alloc_intrinsic_object(heap);
        let bigint_prototype = alloc_intrinsic_object(heap);
        let shared_array_buffer_constructor = alloc_intrinsic_object(heap);
        let shared_array_buffer_prototype = alloc_intrinsic_object(heap);
        let data_view_constructor = alloc_intrinsic_object(heap);
        let data_view_prototype = alloc_intrinsic_object(heap);
        let typed_array_base_constructor = alloc_intrinsic_object(heap);
        let typed_array_base_prototype = alloc_intrinsic_object(heap);
        let int8_array_constructor = alloc_intrinsic_object(heap);
        let int8_array_prototype = alloc_intrinsic_object(heap);
        let uint8_array_constructor = alloc_intrinsic_object(heap);
        let uint8_array_prototype = alloc_intrinsic_object(heap);
        let uint8_clamped_array_constructor = alloc_intrinsic_object(heap);
        let uint8_clamped_array_prototype = alloc_intrinsic_object(heap);
        let int16_array_constructor = alloc_intrinsic_object(heap);
        let int16_array_prototype = alloc_intrinsic_object(heap);
        let uint16_array_constructor = alloc_intrinsic_object(heap);
        let uint16_array_prototype = alloc_intrinsic_object(heap);
        let int32_array_constructor = alloc_intrinsic_object(heap);
        let int32_array_prototype = alloc_intrinsic_object(heap);
        let uint32_array_constructor = alloc_intrinsic_object(heap);
        let uint32_array_prototype = alloc_intrinsic_object(heap);
        let float32_array_constructor = alloc_intrinsic_object(heap);
        let float32_array_prototype = alloc_intrinsic_object(heap);
        let float64_array_constructor = alloc_intrinsic_object(heap);
        let float64_array_prototype = alloc_intrinsic_object(heap);
        let bigint64_array_constructor = alloc_intrinsic_object(heap);
        let bigint64_array_prototype = alloc_intrinsic_object(heap);
        let biguint64_array_constructor = alloc_intrinsic_object(heap);
        let biguint64_array_prototype = alloc_intrinsic_object(heap);
        let string_prototype = alloc_intrinsic_object(heap);
        let symbol_prototype = alloc_intrinsic_object(heap);
        let number_prototype = alloc_intrinsic_object(heap);
        let boolean_prototype = alloc_intrinsic_object(heap);
        let date_prototype = alloc_intrinsic_object(heap);
        let proxy_constructor = alloc_intrinsic_object(heap);
        let error_prototype = alloc_intrinsic_object(heap);
        let error_constructor = alloc_intrinsic_object(heap);
        let type_error_prototype = alloc_intrinsic_object(heap);
        let type_error_constructor = alloc_intrinsic_object(heap);
        let reference_error_prototype = alloc_intrinsic_object(heap);
        let reference_error_constructor = alloc_intrinsic_object(heap);
        let range_error_prototype = alloc_intrinsic_object(heap);
        let range_error_constructor = alloc_intrinsic_object(heap);
        let syntax_error_prototype = alloc_intrinsic_object(heap);
        let syntax_error_constructor = alloc_intrinsic_object(heap);
        let uri_error_prototype = alloc_intrinsic_object(heap);
        let uri_error_constructor = alloc_intrinsic_object(heap);
        let eval_error_prototype = alloc_intrinsic_object(heap);
        let eval_error_constructor = alloc_intrinsic_object(heap);
        let aggregate_error_prototype = alloc_intrinsic_object(heap);
        let aggregate_error_constructor = alloc_intrinsic_object(heap);
        let suppressed_error_prototype = alloc_intrinsic_object(heap);
        let suppressed_error_constructor = alloc_intrinsic_object(heap);
        let map_constructor = alloc_intrinsic_object(heap);
        let map_prototype = alloc_intrinsic_object(heap);
        let set_constructor = alloc_intrinsic_object(heap);
        let set_prototype = alloc_intrinsic_object(heap);
        let promise_constructor = alloc_intrinsic_object(heap);
        let promise_prototype = alloc_intrinsic_object(heap);
        let weakmap_constructor = alloc_intrinsic_object(heap);
        let weakmap_prototype = alloc_intrinsic_object(heap);
        let weakset_constructor = alloc_intrinsic_object(heap);
        let weakset_prototype = alloc_intrinsic_object(heap);
        let weakref_constructor = alloc_intrinsic_object(heap);
        let weakref_prototype = alloc_intrinsic_object(heap);
        let finalization_registry_constructor = alloc_intrinsic_object(heap);
        let finalization_registry_prototype = alloc_intrinsic_object(heap);
        let iterator_prototype = alloc_intrinsic_object(heap);
        let async_iterator_prototype = alloc_intrinsic_object(heap);
        let array_iterator_prototype = alloc_intrinsic_object(heap);
        let string_iterator_prototype = alloc_intrinsic_object(heap);
        let map_iterator_prototype = alloc_intrinsic_object(heap);
        let set_iterator_prototype = alloc_intrinsic_object(heap);
        let generator_function_prototype = alloc_intrinsic_object(heap);
        let generator_prototype = alloc_intrinsic_object(heap);
        let async_generator_function_prototype = alloc_intrinsic_object(heap);
        let async_generator_prototype = alloc_intrinsic_object(heap);
        let regexp_constructor = alloc_intrinsic_object(heap);
        let regexp_prototype = alloc_intrinsic_object(heap);
        // Intl (ECMA-402)
        let intl_namespace = alloc_intrinsic_object(heap);
        let intl_collator_constructor = alloc_intrinsic_object(heap);
        let intl_collator_prototype = alloc_intrinsic_object(heap);
        let intl_number_format_constructor = alloc_intrinsic_object(heap);
        let intl_number_format_prototype = alloc_intrinsic_object(heap);
        let intl_plural_rules_constructor = alloc_intrinsic_object(heap);
        let intl_plural_rules_prototype = alloc_intrinsic_object(heap);
        let intl_locale_constructor = alloc_intrinsic_object(heap);
        let intl_locale_prototype = alloc_intrinsic_object(heap);
        let intl_date_time_format_constructor = alloc_intrinsic_object(heap);
        let intl_date_time_format_prototype = alloc_intrinsic_object(heap);
        let intl_list_format_constructor = alloc_intrinsic_object(heap);
        let intl_list_format_prototype = alloc_intrinsic_object(heap);
        let intl_segmenter_constructor = alloc_intrinsic_object(heap);
        let intl_segmenter_prototype = alloc_intrinsic_object(heap);
        let intl_segments_prototype = alloc_intrinsic_object(heap);
        let intl_segment_iterator_prototype = alloc_intrinsic_object(heap);
        let intl_display_names_constructor = alloc_intrinsic_object(heap);
        let intl_display_names_prototype = alloc_intrinsic_object(heap);
        let intl_relative_time_format_constructor = alloc_intrinsic_object(heap);
        let intl_relative_time_format_prototype = alloc_intrinsic_object(heap);
        // Temporal (proposal-temporal)
        let temporal_namespace = alloc_intrinsic_object(heap);
        let temporal_instant_constructor = alloc_intrinsic_object(heap);
        let temporal_instant_prototype = alloc_intrinsic_object(heap);
        let temporal_duration_constructor = alloc_intrinsic_object(heap);
        let temporal_duration_prototype = alloc_intrinsic_object(heap);
        let temporal_plain_date_constructor = alloc_intrinsic_object(heap);
        let temporal_plain_date_prototype = alloc_intrinsic_object(heap);
        let temporal_plain_time_constructor = alloc_intrinsic_object(heap);
        let temporal_plain_time_prototype = alloc_intrinsic_object(heap);
        let temporal_plain_date_time_constructor = alloc_intrinsic_object(heap);
        let temporal_plain_date_time_prototype = alloc_intrinsic_object(heap);
        let temporal_plain_year_month_constructor = alloc_intrinsic_object(heap);
        let temporal_plain_year_month_prototype = alloc_intrinsic_object(heap);
        let temporal_plain_month_day_constructor = alloc_intrinsic_object(heap);
        let temporal_plain_month_day_prototype = alloc_intrinsic_object(heap);
        let temporal_zoned_date_time_constructor = alloc_intrinsic_object(heap);
        let temporal_zoned_date_time_prototype = alloc_intrinsic_object(heap);
...
#[cfg(test)]
mod tests {
    use super::{IntrinsicRoot, IntrinsicsStage, VmIntrinsics, alloc_intrinsic_object};
    use crate::host::NativeFunctionRegistry;
    ...
    fn intrinsics_trace_roots_covers_objects_and_symbols() {
        let mut heap = crate::object::ObjectHeap::new();
        let mut intrinsics = VmIntrinsics::allocate(&mut heap);
        let namespace = alloc_intrinsic_object(&mut heap);
