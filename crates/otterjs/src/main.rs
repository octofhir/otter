...
fn dump_gc_stats() {
    ...
    eprintln!(
        "gc_stats: collections={} reclaimed_last={} total_pause_us={} avg_pause_us={:.0}",
    ...
    eprintln!(
        "gc_pause_histogram: <1ms={} 1-5ms={} 5-10ms={} 10-50ms={} 50-100ms={} >100ms={} total={}",
        hist.under_1ms,
        hist.ms_1_to_5,
        hist.ms_5_to_10,
        hist.ms_10_to_50,
...
fn dump_alloc_stats() {
    if let Some(mm) = otter_vm_core::memory::MemoryManager::current() {
        eprintln!(
            "alloc_stats: allocated={} limit={} alloc_count={} last_live={}",
            mm.allocated(),
            mm.limit(),
            mm.allocation_count(),
            mm.last_live_size(),
        ...
        eprintln!(
            "alloc_categories: objects={} ({}B) arrays={} strings={} closures={} other={}",
            snap.object_count,
            snap.object_bytes,
            snap.array_count,
            snap.string_count,
