...
pub const OP_BYTE_TABLE: &[(Op, u8)] = &[
    ...
    (Op::NewFunction, 0x57),
    (Op::GlobalCall, 0x58),
    (Op::LoadGlobalThis, 0x59),
    (Op::LoadGlobalOrThrow, 0x5A),
    (Op::CollectArguments, 0x5B),
    (Op::LoadGlobalOrUndefined, 0x5C),
    (Op::DefineGlobalVar, 0x5D),
    (Op::ImportMetaResolve, 0x5E),
    (Op::ImportNamespaceDynamic, 0x5F),
    (Op::ImportNamespace, 0x60),
    (Op::PromiseFulfilledOf, 0x61),
    (Op::NewIntl, 0x62),
    (Op::TemporalCall, 0x63),
    (Op::TemporalLoad, 0x64),
    (Op::NewCollection, 0x65),
    (Op::NewWeakRef, 0x66),
    (Op::NewFinalizationRegistry, 0x67),
    (Op::SymbolLoad, 0x68),
    (Op::SymbolCall, 0x69),
    (Op::TypeOf, 0x6A),
    (Op::DeleteElement, 0x6B),
    (Op::Await, 0x6C),
    (Op::SameValue, 0x6D),
    (Op::IsArray, 0x6E),
    (Op::LooseEqual, 0x6F),
    (Op::LooseNotEqual, 0x70),
    (Op::NewBuiltinError, 0x71),
    (Op::LoadBuiltinError, 0x72),
    (Op::DateCall, 0x73),
    (Op::BigIntCall, 0x74),
    (Op::ArrayConstruct, 0x75),
    (Op::ArrayFrom, 0x76),
    (Op::ArrayOf, 0x77),
    (Op::ObjectCall, 0x78),
    (Op::ArrayBufferCall, 0x79),
    (Op::DataViewCall, 0x7A),
    (Op::TypedArrayCall, 0x7B),
    (Op::Yield, 0x7C),
    (Op::SharedArrayBufferCall, 0x7D),
    (Op::ProxyCall, 0x7E),
    (Op::ReflectCall, 0x7F),
    (Op::IteratorCall, 0x80),
    (Op::ToPrimitive, 0x81),
];
...
mod tests {
    ...
    fn coverage_matches_dispatcher_enum_size() {
        ...
        const EXPECTED_OPCODE_COUNT: usize = 130;
        assert_eq!(
            OP_BYTE_TABLE.len(),
