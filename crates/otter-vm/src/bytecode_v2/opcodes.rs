...
//! - Phase 2's AST lowering (`source_compiler_v2`, TBD).
//! - Phase 3's dispatch (`interpreter/dispatch_v2.rs`, TBD).
...
impl OpcodeV2 {
    ...
    pub const fn from_byte(byte: u8) -> Option<Self> {
        ...
        // values that are actual discriminants of OpcodeV2. The explicit
    ...
    pub const fn is_suspend(self) -> bool {
        matches!(
            self,
            OpcodeV2::Yield | OpcodeV2::YieldStar | OpcodeV2::Await | OpcodeV2::SuspendGenerator
        )
    }
}
