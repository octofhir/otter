...
- [ ] Replace the interpreter's measured dispatch/boxed-register/runtime-entry
  bottleneck with generated bytecode handlers and shared IC fast paths. The
  controlled property kernel is about 29x slower than Node `--jitless`; retain
