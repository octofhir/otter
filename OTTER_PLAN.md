...
- [x] Remove the measured duplicate instruction/operand decoding path: the VM
  ...
  boxed-double-property 1.95x, numeric-leaf 1.75x, wall on M1). Template numeric-
  leaf (1.75x, the weakest) is near its baseline ceiling — further gains need
  type-specialized unboxed regalloc, i.e. optimizing-tier work.
