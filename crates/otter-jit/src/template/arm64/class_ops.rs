//! Class-construction transition emission.
//!
//! # Contents
//! - Reentrant calls to the VM-owned class helper.
//! - Uniform success, throw, and exact pre-effect bailout routing.
//!
//! # Invariants
//! - The VM helper commits every supported class opcode before returning
...
pub(super) fn emit_class_op(
    ...
    emit_load_u64(ops, 16, transitions.variadic_entry(abi::STUB_JIT_CLASS_OP));
    dynasm!(ops
        ; .arch aarch64
        ; blr x16
        ; cbz x0, =>done
